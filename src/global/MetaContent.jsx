    ...
    return(
        ...
        <div className="container">
            ...
            <div className="content">
                ...
                <p className="font-14 jost color-767676">
                We take pride in crafting Indian Sheesham wood furniture that resonates with heritage and finesse. Every item is a labor of love and a testament to Jodhpur's craftsmanship's long-standing traditions. You not only bring home a work of art from Whimsical Woods, but also a piece of history..
                </p>
            </div>
            <div className="content">
                <h1 className="jost fw-600 color-22222 mb-0">Unmatched Variety in Whimsical Woods</h1>
                <p className="font-14 jost color-767676">
                Explore a diverse array of options in our collection. From classic to modern, we offer an extensive range of Whimsical Woods designs, each one crafted with precision and passion. Our commitment to quality and attention to detail is evident in every piece, making it not just furniture, but a testament to exceptional craftsmanship.
                </p>
            </div>
            <div className="content">
            ...
            <div className="content">
                <h1 className="jost fw-600 color-22222 mb-0">Experience Whimsical Woods - Visit Our Showrooms Across India</h1>
                <p className="font-14 jost color-767676">
                Immerse yourself in the world of Whimsical Woods by visiting our showrooms across India. Witness the artistry up close, feel the textures, and let our knowledgeable staff guide you to finding the perfect pieces for your home.
                </p>
            </div>
            <div className="content">
            ...
            <div className="content">
                ...
                <p className="font-14 jost color-767676">
                Your satisfaction is our priority. Our dedicated team is available to address your queries, provide guidance, and ensure that your experience with Whimsical Woods is nothing short of exceptional.
                </p>
            </div>
            <div className="content">
                <h1 className="jost fw-600 color-22222 mb-0">Their Words, Our Pride</h1>
                <p className="font-14 jost color-767676">
                Happy Words of our Happy Customers Reviews with photos Manish Chouhan 8696 Best quality solid sheesham wood furniture. Thank you Whimsical Woods Preeti Mathur We purchased some wood furniture from this shop. The quality of the sheesham wood furniture is great. Riya Garg This sheesham wood furniture bed is a must buy. And the quality of this dressing table is good too.
                </p>
            </div>
