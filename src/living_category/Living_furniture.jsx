...
const Living_furniture = () =>{
    ...
    return(
        <div className='bedroom-category'>
         ...
         <h1 className='font-36 fw-600 jost'>Living Furniture</h1>
        <h2 className='font-16 jost fw-normal'>Create the living room of your dreams with the perfect Furniture</h2>
        <Slider {...settings}>
...
export default Living_furniture;
