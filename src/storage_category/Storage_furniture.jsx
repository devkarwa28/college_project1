...
const Storage_furniture = () =>{
    ...
    return(
        <div className='bedroom-category'>
         ...
         <h1 className='font-36 fw-600 jost'>Storage Furniture</h1>
        <h2 className='font-16 jost fw-normal'>Create the Storage of your dreams with the perfect Furniture</h2>
        <Slider {...settings}>
...
export default Storage_furniture;
