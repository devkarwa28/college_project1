...
const Sofa_furniture = () =>{
    ...
    return(
        <div className='bedroom-category'>
         ...
         <h1 className='font-36 fw-600 jost'>Sofa Furniture</h1>
        <h2 className='font-16 jost fw-normal'>Create the Living Room of your dreams with the perfect bed</h2>
        <Slider {...settings}>
